...
import com.sonicwall.api.HomeController;
...
public class SwaggerDocumentationConfig {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
            .title("My Sonicwall API Reference")
            ...
            .termsOfServiceUrl("")
            .version("1.0.0_alfa")
            //.contact(new Contact("Sonicwall EmailSecurity Team","", ""))
            .build();
    }
    ...
    public Docket customImplementation(){
		return new Docket(DocumentationType.SWAGGER_2)
            ...
            .select()
                ...
                .apis(RequestHandlerSelectors.basePackage("com.sonicwall.api"))
                .build()
            .pathMapping("/")
